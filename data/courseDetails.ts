...
export const courseDetails: { [key: string]: CourseDetail } = {
  "jee-preparation": {
    ...
    fullDescription:
      "Our JEE preparation program is designed to help students crack one of India's toughest engineering entrance exams. With experienced faculty, comprehensive study material, regular mock tests, and personalized doubt-clearing sessions, we ensure that every student gets the support they need to succeed.",
    ...
    founderMessage:
      "JEE is not just an exam—it's a gateway to your engineering dreams. Our program is designed to build strong fundamentals while developing problem-solving skills that will serve you throughout your career.",
  ...
  "neet-preparation": {
    ...
    fullDescription:
      "Our NEET program provides comprehensive preparation for aspiring medical students. With expert faculty, extensive practice, and regular assessments, we help students achieve their dream of becoming doctors.",
    eligibility: "Students in 11th, 12th, or 12th Pass",
    syllabus: [
    ...
    founderMessage:
      "Medicine is a noble profession. Our NEET program not only prepares you for the exam but also instills the dedication and discipline required to become an excellent doctor.",
  ...
  "full-stack-web-development": {
    ...
    fullDescription:
      "Transform into a professional full-stack web developer with our comprehensive program covering frontend, backend, and database technologies. Build real-world projects and get placement assistance.",
    ...
    founderMessage:
      "The web development industry offers limitless opportunities. Our program ensures you gain practical skills that companies are actively looking for.",
    founderName: "Rajesh Kumar, Founder",
  ...
  "mern-stack-development": {
    ...
    fullDescription:
      "Master the MERN stack and become job-ready with hands-on projects, industry mentorship, and placement support.",
    ...
    founderMessage:
      "MERN stack is one of the most sought-after skill sets in the industry. We ensure you become proficient enough to handle real-world challenges.",
    founderName: "Priya Sharma, Co-Founder",
    fees: "₹40,000",
  },
  "python-aiml": {
    ...
    fullDescription:
      "Dive into the world of AI and Machine Learning with Python. Learn from basics to advanced concepts with real-world projects.",
    ...
    founderMessage:
      "AI and ML are shaping the future. Our program equips you with skills that are in high demand across all industries.",
    founderName: "Rajesh Kumar, Founder",
    fees: "₹50,000",
  },
  "11th-12th-science": {
    ...
    fullDescription:
      "Our 11th & 12th Science program provides comprehensive coaching for PCMB (Physics, Chemistry, Mathematics, Biology) with focus on both board exams and competitive exam preparation. Expert faculty with proven track record ensure conceptual clarity and problem-solving skills.",
    ...
    founderMessage:
      "11th and 12th are crucial years that shape your future. We focus on building strong fundamentals while preparing you for board exams and beyond.",
  ...
  "11th-12th-commerce": {
    ...
    fullDescription:
      "Our Commerce program provides in-depth coverage of Accountancy, Business Studies, Economics, and Mathematics with practical examples and case studies. Perfect for students aiming for CA, CS, or BBA.",
    ...
    founderMessage:
      "Commerce is the backbone of business. We prepare you not just for exams but for real-world business challenges.",
  ...
  "jee-main-advanced": {
    ...
    description:
      "Intensive preparation for India's premier engineering entrance exam with mock tests, doubt sessions, and expert mentorship.",
    fullDescription:
      "Crack JEE Main & Advanced with our comprehensive program designed by IIT alumni. We focus on concept clarity, problem-solving techniques, and exam strategy to help you secure a top rank.",
    eligibility: "Students in 11th, 12th, or 12th Pass",
    syllabus: [
    ...
    founderMessage:
      "JEE requires dedication and smart preparation. Our proven methodology has helped hundreds of students achieve their IIT dreams.",
    founderName: "MD. RIZWAN, Founder",
    fees: "₹80,000",
  },
  "foundation-courses": {
    ...
    fullDescription:
      "Start your competitive exam preparation early with our foundation courses. Build strong conceptual understanding in 9th and 10th to excel in future competitive exams like JEE and NEET.",
    ...
    founderMessage:
      "Early preparation gives you a head start. Our foundation courses ensure you develop the right approach and skills for competitive exams.",
    founderName: "MD. RIZWAN, Founder",
  ...
  "bba-program-support": {
    ...
    fullDescription:
      "Get comprehensive support for your BBA journey with our industry-aligned curriculum. We cover core business subjects, practical case studies, and soft skills development to make you industry-ready.",
    ...
    founderMessage:
      "BBA is your gateway to the business world. We ensure you're not just academically sound but also industry-ready.",
    founderName: "MD. FARHAN, Co-Founder",
  ...
  "business-management": {
    ...
    fullDescription:
      "Learn essential business management skills through our intensive 6-month program. Cover all aspects of running a business from marketing to finance, with practical assignments and case studies.",
    ...
    founderMessage:
      "Modern businesses need versatile managers. Our program develops both strategic thinking and practical execution skills.",
    founderName: "MD. FARHAN, Co-Founder",
    fees: "₹35,000",
  },
  "data-science-analytics": {
    ...
    fullDescription:
      "Become a data science professional with our comprehensive program covering statistical analysis, machine learning, data visualization, and big data tools. Work on real-world datasets and build a strong portfolio.",
    eligibility: "12th Pass or Graduate, Basic Computer Knowledge",
    syllabus: [
    ...
    founderMessage:
      "Data is the new oil. Our program transforms you into a skilled data professional who can extract insights and drive business decisions.",
    founderName: "MD. FARHAN, Co-Founder",
    fees: "₹55,000",
  },
  "cloud-computing-awsazure": {
    ...
    fullDescription:
      "Master cloud computing with hands-on training in AWS and Azure. Learn cloud architecture, deployment, monitoring, and DevOps practices to become a certified cloud professional.",
    ...
    founderMessage:
      "Cloud computing is the future of IT infrastructure. Get certified and join the fastest-growing tech domain.",
    founderName: "MD. FARHAN, Co-Founder",
    fees: "₹40,000",
  },
  "mobile-app-development": {
    ...
    fullDescription:
      "Learn to build professional mobile applications for iOS and Android. Master cross-platform frameworks like React Native and Flutter, or dive into native development with practical projects.",
    ...
    founderMessage:
      "Mobile apps are everywhere. Learn to create the apps that millions will use and start your journey as a mobile developer.",
    founderName: "MD. FARHAN, Co-Founder",
    fees: "₹45,000",
  },
  "uiux-design": {
    ...
    fullDescription:
      "Master the art of UI/UX design with industry-standard tools. Learn design thinking, wireframing, prototyping, and user research to create beautiful and functional digital experiences.",
    ...
    founderMessage:
      "Great design is invisible but impactful. Learn to create experiences that users love and businesses value.",
    founderName: "MD. FARHAN, Co-Founder",
    fees: "₹30,000",
  },
  "bcamcabsc-it-support": {
    ...
    fullDescription:
      "Get comprehensive support for your BCA, MCA, or BSc IT degree with our academic coaching and industry-aligned skill development. We bridge the gap between academics and industry requirements.",
